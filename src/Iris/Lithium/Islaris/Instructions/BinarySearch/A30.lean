...
(trace
  ...
  (write-reg |SEE| nil (_ bv1687 128))
  ...
  (read-reg |R8| nil v29)
  (define-const v58 (bvadd ((_ extract 63 0) ((_ zero_extend 64) v27)) ((_ extract 63 0) ((_ zero_extend 64) (bvlshr v29 #x0000000000000001)))))
  (write-reg |R24| nil v58)
