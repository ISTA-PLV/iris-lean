...
(trace
  ...
  (write-reg |SEE| nil (_ bv1597 128))
  ...
  (define-const v28 (bvadd v26 #x0000000000000004))
  (read-reg |__isla_vector_gpr| nil false)
  (write-reg |R30| nil v28)
  (define-const v29 (bvadd v26 #x000000000000000c))
