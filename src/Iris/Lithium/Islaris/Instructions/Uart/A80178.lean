...
(trace
  ...
  (write-reg |SEE| nil (_ bv1233 128))
  ...
  (read-reg |R1| nil v26)
  (define-const v30 (= (bvor #b0 ((_ extract 0 0) (bvlshr ((_ extract 31 0) v26) #x00000005))) #b1))
  (cases "model/aarch64.sail 12130:4 - 12132:5"
    (trace
      (assert v30)
      (declare-const v31 (_ BitVec 64)) 
      (read-reg |_PC| nil v31)
      (define-const v32 (bvadd v31 #x0000000000000014))
