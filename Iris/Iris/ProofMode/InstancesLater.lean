...
instance (priority := default - 10) intoLaterN_later [BI PROP] only_head n n' m' (P Q lQ : PROP)
...
instance (priority := default - 20) intoLaterN_laterN [BI PROP] only_head n m n' m' (P Q lQ : PROP)
