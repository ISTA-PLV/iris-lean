...
public meta import Iris.Std.DeclarationNames
...
@[inherit_doc FromMathlib.Linter.linter.style.missingEnd]
...
def cdotLinter : Linter where run := withSetOptionIn fun stx ↦ do
    ...
    for cdot in FromMathlib.Linter.findCDot stx do
...
@[inherit_doc FromMathlib.Linter.linter.style.longFile]
...
@[inherit_doc FromMathlib.Linter.linter.style.longLine]
...
@[inherit_doc FromMathlib.Linter.linter.style.openClassical]
